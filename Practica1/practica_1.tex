...
\begin{itemize}
    ...
    \item \code{binaryAttributesNominal False/True}: Permite establecer si los valores de los nuevos atributos binarios serán valores numéricos 0-1 o si serán textuales f-t.
...
Para ilustrar el funcionamiento de este filtro se ha cargado en Weka la base de datos \code{breast-cancer.arff}.
