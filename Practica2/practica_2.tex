...
\begin{figure}[ht]
    \centering
    \includegraphics[trim={0cm 10.4cm 6.9cm 0.7cm},clip]{clasificador-logistico-resultados-03}
...
\begin{figure}[ht]
    \centering
    \includegraphics[trim={0cm 10.4cm 7cm 0.7cm},clip]{clasificador-logistico-resultados-02}
