...
Respecto a la selección de atributos, gracias al filtro \code{CorrelationAttributeEval} podemos ver que el atributo \code{color} tiene muy poca influencia sobre la clase (ver fig. \ref{fig:fantasmas-irrelevantes}). Se trata del atributo \code{color} por lo que se procede a su eliminación. También se han estudiado las posibles correlaciones entre los atributos, pero ninguna es significativa (ver fig. \ref{fig:fantasmas-correlaciones}) No se han encontrado valores extremos. Sí 5 outliers, pero estos no requieren tratamiento.
...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=.8]{knn-02-resultado}
...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=.8]{sl-03-resultado}
