...
\begin{figure}[ht]
    \centering
    \includegraphics[width=.7\textwidth,keepaspectratio=true]{mlp-red}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=.3\textwidth,keepaspectratio=true]{mlp-configuracion}
...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=.8]{mlp-resultados}
